...
export function Play() {
    (function (t, e) {
        ...
        function _() {
            ...
            return t < 0 || t > 1 || n < 0 || n > 1
                ...
                : function (i) {
                      ...
                      if (i >= 1)
                          return n < 1 ? 1 + ((i - 1) * (r - 1)) / (n - 1) : 1 === n && t < 1 ? 1 + ((i - 1) * (e - 1)) / (t - 1) : 1;
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var s = 0;
                                    return (
                                        i[1][1] < 0 ? ((s = j(i[1][1]) * T), i[0][1] < 0 && (s = 360 - s)) : (s = M(i[0][1]) * T),
                                        u && (s = -s),
        ...
        function L(t, e, n) {
            return 0 === t ? e : 1 === t ? n : { x: D(t, e.x, n.x), y: D(t, e.y, n.y) };
        }
        function V(t, e, n) {
        ...
        function z(t, e, n) {
            return 0 === t
                ...
                : 1 === t
                ? n
                : { r: G(t, e.r, n.r), g: G(t, e.g, n.g), b: G(t, e.b, n.b), a: D(t, null == e.a ? 1 : e.a, null == n.a ? 1 : n.a) };
        }
        function Y(t, e, n) {
            var r = e.length;
        ...
        function Z(t, e, n) {
            ...
            return null == a
                ...
                ? r
                    ? [o, 1, a.v]
                    : a.v
                : ((t = (t - u.t) / (a.t - u.t)), u.e && (t = u.e(t)), r ? [o, t, n(t, u.v, a.v)] : n(t, u.v, a.v));
        }
        function tt(t, e) {
        ...
        function st(t, e) {
            ...
            return r.length ? { svg: n, animations: r, animationSettings: t.animationSettings, options: t.options || void 0 } : null;
        }
        function ft(t) {
                                ...
                                value: function () {
                                    ...
                                    var o = function o(u) {
                                        ...
                                        if (
                                            a >= n + l &&
                                            !t._rollingBack &&
                                            ((t.offset = a), (n = a), t._apply(a, i) === t._animations.length)
                                        )
                ...
                var o = (function (t) {
                    var e,
                        ...
                        i =
                            t &&
                            1 ===
                                (null === (e = t.ownerDocument) || void 0 === e || null === (n = e.childNodes) || void 0 === n
                                    ? void 0
                                    : n.length) &&
                            ...
                            o = function () {
                                for (var o = 0, u = n.innerHeight, a = 0, l = n.innerWidth, s = t.parentNode; s instanceof Element; ) {
                                    ...
                                    if ('visible' !== f.overflowY || 'visible' !== f.overflowX) {
                                        ...
                                        'visible' !== f.overflowY && ((o = Math.max(o, c.top)), (u = Math.min(u, c.bottom))),
                                            'visible' !== f.overflowX && ((a = Math.max(a, c.left)), (l = Math.min(l, c.right)));
                                    }
        ...
        var _t = {
            ...
            At = {
                f: null,
                i: function (t, e, n) {
                    return 0 === t ? e : 1 === t ? n : { width: C(t, e.width, n.width), height: C(t, e.height, n.height) };
                },
                u: function (t, e) {
                    return function (n) {
                        var r = e(n);
        ...
        function Rt(t, e, n, r) {
            var i = arguments.length > 4 && void 0 !== arguments[4] && arguments[4],
                o = Mt(t, e, null, n, r);
            return o || (o = { x: Tt(t.x, e.x, n.x, r), y: Tt(t.y, e.y, n.y, r) }), i && (o.a = Ft(t, e, n, r)), o;
        }
        function Ft(t, e, n, r) {
        ...
        function qt(t, e, n, r, i) {
            var o = arguments.length > 5 && void 0 !== arguments[5] && arguments[5],
                u = Mt(t, e, n, r, i);
            return u || (u = { x: Dt(t.x, e.x, n.x, r.x, i), y: Dt(t.y, e.y, n.y, r.y, i) }), o && (u.a = Lt(t, e, n, r, i)), u;
        }
        ...
        var Zt = { gt: 'gradientTransform', c: { x: 'cx', y: 'cy' }, rd: 'r', f: { x: 'x1', y: 'y1' }, to: { x: 'x2', y: 'y2' } };
        ...
        function oe(t, e, n) {
            return 0 === t
                ...
                : 1 === t
                ? n
                : { blur: V(t, e.blur, n.blur), offset: L(t, e.offset, n.offset), color: z(t, e.color, n.color) };
        }
        var ue = {
            blur: V,
            brightness: C,
                ...
                (this.off = function (t, n) {
                    for (var r in e)
                        if (e.hasOwnProperty(r) && r.substr(0, t.length) === t)
                            if (n) for (var i = 0; i < e[r].length; i++) e[r][i] === n && (e[r][i] = null);
                            else e[r] = null;
                }),
                (this.trigger = function () {
                    ...
                    t: for (var u in e)
                        if (e.hasOwnProperty(u) && e[u] && (u === i || u.substr(0, i.length + 1) === i + '.'))
                            for (var a = 0; a < (e[u] || []).length; a++) if (e[u][a] && !1 === (n = e[u][a].apply(t, o))) break t;
                    return n;
                });
        }
        var pe = !0,
                        ...
                        [
                            {
                                ...
                                value: function () {
                                    ...
                                    !this._rollingBack || this.rollbackStartOffset <= this.duration
                                        ...
                                        : ((this.offset = this.rollbackStartOffset - ((this.rollbackStartOffset - this.offset) % e)),
                                          (this.rollbackStartOffset = 0));
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    i && this.pause(!1, !1),
                                        (this.offset =
                                            this.iterations > 0
                                                ? ((e = t), (n = 0), (r = this.maxFiniteDuration), e < n ? n : e > r ? r : e)
                                                : Math.max(t, 0)),
                                    ...
                                    (n.svgatorPlayer = o),
                                        ...
                                        (function (t, e, n) {
                                            if ('click' === n.start) {
                                                ...
                                                return (
                                                    t._handlers.push({ element: e, event: 'click', handler: r }),
                                            ...
                                            if ('hover' === n.start) {
                                                ...
                                                t._handlers.push({ element: e, event: 'mouseenter', handler: i }),
                                                ...
                                                return (
                                                    t._handlers.push({ element: e, event: 'mouseleave', handler: o }),
                                        ...
                                        (function (t, e, n) {
                                            ...
                                            'function' == typeof Event
                                                ? (r = new Event('ready'))
                                                : (r = document.createEvent('Event')).initEvent('ready', !0, !0);
            ...
            animations: [
                {
                    elements: {
                        ej5uRKs9mLC28: {
                            fill: [
                                { t: 0, v: { t: 'c', v: { r: 247, g: 248, b: 244, a: 1 } } },
                                { t: 3000, v: { t: 'c', v: { r: 224, g: 228, b: 215, a: 1 } } },
                            ],
                        },
                        ej5uRKs9mLC30: {
                            fill: [
                                { t: 0, v: { t: 'c', v: { r: 235, g: 237, b: 224, a: 1 } } },
                                { t: 3000, v: { t: 'c', v: { r: 247, g: 248, b: 244, a: 1 } } },
                            ],
                        },
                        ej5uRKs9mLC31: {
                            d: [
                            ...
                            fill: [
                                { t: 0, v: { t: 'c', v: { r: 134, g: 135, b: 128, a: 1 } } },
                                { t: 3000, v: { t: 'c', v: { r: 134, g: 135, b: 128, a: 1 } } },
                            ],
                        },
                        ej5uRKs9mLC32: {
                            d: [
                            ...
                            '#filter': {
                                keys: [
                                    {
                                        ...
                                        v: [
                                            {
                                                type: 'inner-shadow',
                                                value: { blur: { x: 2, y: 0 }, offset: { x: -2, y: 0 }, color: { r: 0, g: 0, b: 0, a: 1 } },
                                            },
                                            {
                                                type: 'inner-shadow',
                                                value: { blur: { x: 0, y: 0 }, offset: { x: 0, y: 0 }, color: { r: 0, g: 0, b: 0, a: 1 } },
                                            },
                                        ],
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        v: [
                                            ...
                                            {
                                                type: 'inner-shadow',
                                                value: { blur: { x: 2, y: 0 }, offset: { x: 0, y: 0 }, color: { r: 0, g: 0, b: 0, a: 1 } },
                                            },
                                        ],
                                    },
                                ],
                                data: {
                                    items: [
                                        ['inner-shadow', 'ej5uRKs9mLC32-filter-inner-shadow-0'],
                                        ['inner-shadow', 'ej5uRKs9mLC32-filter-inner-shadow-1'],
                                    ],
                                },
                            },
                            fill: [
                                { t: 0, v: { t: 'c', v: { r: 247, g: 248, b: 244, a: 1 } } },
                                { t: 100, v: { t: 'c', v: { r: 247, g: 248, b: 244, a: 1 } } },
                                { t: 2800, v: { t: 'c', v: { r: 247, g: 248, b: 243, a: 1 } } },
                                { t: 3000, v: { t: 'c', v: { r: 247, g: 248, b: 244, a: 1 } } },
                            ],
                        },
                    },
                    s: '',
                },
            ],
            options: 'MDKAxMFc4MjI5NU2E3Yk1GNjg3LOVE3YjI5UDQQxMjk3Mzc2NjXg2YjI5ODQ/',
        },
        '__SVGATOR_PLAYER__',
        window,
        document
